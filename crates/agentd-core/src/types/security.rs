...
impl SecurityDenialReason {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MatrixUserDisabled => "matrix_user_disabled",
            Self::MatrixDeviceRequired => "matrix_device_required",
            ...
            Self::PlacementClassificationDenied => "placement_classification_denied",
            Self::PlacementRegionDenied => "placement_region_denied",
            Self::PlacementTrustDomainDenied => "placement_trust_domain_denied",
            Self::PlacementImageDigestInvalid => "placement_image_digest_invalid",
