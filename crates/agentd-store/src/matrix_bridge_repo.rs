...
pub async fn upsert_room(
    ...
    sqlx::query(
        "INSERT INTO matrix_bridge_rooms \
         (room_id, group_name, agent_name, trusted, trust_reason, inviter_mxid, created_at, updated_at) \
         VALUES (?, ?, ?, ?, ?, ?, ?, ?) \
...
pub async fn get_room(
    ...
    let row = sqlx::query(
        "SELECT room_id, group_name, agent_name, trusted, trust_reason, inviter_mxid, \
