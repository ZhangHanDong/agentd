...
| GitHub Adapter   | **(Δ6) execution-time PR open only**, via a Specify-provisioned token | issue pull/push, webhooks, status-check ownership — GitHub is owned by **Specify**, not agentd |
...
| ------------------------------------- | ----------------------------------- | ----------------------------------------------------------- | ----------------------------------------------- | -------------------------------------------------- |
| Issue title/body/labels               | **Specify** (Δ3; Specify may back onto GitHub) | `agentd.db.issues` (per-run cache, not a mirror) | agentd pulls via the Specify client (P1) / standalone dev path | NOT an agentd-owned GitHub issue mirror            |
